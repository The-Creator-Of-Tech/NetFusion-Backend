"""
NetFusion OpenAI Provider Adapter
Implements BaseAIProvider for OpenAI Chat Completions API.
"""
...
class OpenAIProvider(BaseAIProvider):
    ...
    def __init__(self, config: ProviderConfig):
        ...
        self.config.api_base = self.config.api_base or "https://api.openai.com/v1"
    ...
    def generate(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            raise ProviderError("OpenAI", f"API invocation failed: {str(e)}", e) from e
