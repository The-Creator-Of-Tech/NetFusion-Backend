...
async function main() {
    ...
    // Tactic
    const tactic = await prisma_1.default.mitreTactic.findUnique({ where: { id: '029f2e3a-6f0a-4b9a-bbcb-7c73a1d9a001' } });
    ...
    // Techniques
    const tech1 = await prisma_1.default.mitreTechnique.findUnique({ where: { id: '129f2e3a-6f0a-4b9a-bbcb-7c73a1d9a101' } });
    ...
    const tech2 = await prisma_1.default.mitreTechnique.findUnique({ where: { id: '129f2e3a-6f0a-4b9a-bbcb-7c73a1d9a102' } });
    ...
    // Mitigations
    const mit1 = await prisma_1.default.mitreMitigation.findUnique({ where: { id: '229f2e3a-6f0a-4b9a-bbcb-7c73a1d9a201' }, include: { techniques: true } });
    ...
    const mit2 = await prisma_1.default.mitreMitigation.findUnique({ where: { id: '229f2e3a-6f0a-4b9a-bbcb-7c73a1d9a202' }, include: { techniques: true } });
    ...
    // CVEs
    const cve1 = await prisma_1.default.cVE.findUnique({ where: { id: '329f2e3a-6f0a-4b9a-bbcb-7c73a1d9a301' }, include: { techniques: true } });
    ...
    const cve2 = await prisma_1.default.cVE.findUnique({ where: { id: '329f2e3a-6f0a-4b9a-bbcb-7c73a1d9a302' }, include: { techniques: true } });
    ...
    // CVSS details
    const cvss1 = await prisma_1.default.cVSS.findUnique({ where: { id: '429f2e3a-6f0a-4b9a-bbcb-7c73a1d9a401' } });
    ...
    const cvss2 = await prisma_1.default.cVSS.findUnique({ where: { id: '429f2e3a-6f0a-4b9a-bbcb-7c73a1d9a402' } });
    ...
    // Affected Products
    const ap1 = await prisma_1.default.affectedProduct.findUnique({ where: { id: '529f2e3a-6f0a-4b9a-bbcb-7c73a1d9a501' } });
    ...
    const ap2 = await prisma_1.default.affectedProduct.findUnique({ where: { id: '529f2e3a-6f0a-4b9a-bbcb-7c73a1d9a502' } });
    ...
    // IOCs
    const ioc1 = await prisma_1.default.iOC.findUnique({ where: { id: '629f2e3a-6f0a-4b9a-bbcb-7c73a1d9a601' }, include: { cves: true, techniques: true } });
    ...
    const ioc2 = await prisma_1.default.iOC.findUnique({ where: { id: '629f2e3a-6f0a-4b9a-bbcb-7c73a1d9a602' }, include: { cves: true, techniques: true } });
    ...
    // IOC Enrichments
    const enc1 = await prisma_1.default.iOCEnrichment.findUnique({ where: { id: '829f2e3a-6f0a-4b9a-bbcb-7c73a1d9a801' } });
    ...
    const enc2 = await prisma_1.default.iOCEnrichment.findUnique({ where: { id: '829f2e3a-6f0a-4b9a-bbcb-7c73a1d9a802' } });
    ...
    // Threat Actor
    const actor = await prisma_1.default.threatActor.findUnique({ where: { id: '929f2e3a-6f0a-4b9a-bbcb-7c73a1d9a901' }, include: { techniques: true, iocs: true } });
    ...
    // Campaign
    const campaign = await prisma_1.default.threatCampaign.findUnique({ where: { id: 'a29f2e3a-6f0a-4b9a-bbcb-7c73a1d9aa01' }, include: { threatActors: true, techniques: true, iocs: true } });
    ...
    // IOC Relationships
    const iocRel1 = await prisma_1.default.iOCRelationship.findUnique({ where: { id: '729f2e3a-6f0a-4b9a-bbcb-7c73a1d9a701' } });
    ...
    const iocRel2 = await prisma_1.default.iOCRelationship.findUnique({ where: { id: '729f2e3a-6f0a-4b9a-bbcb-7c73a1d9a702' } });
    ...
    const threatRel1 = await prisma_1.default.threatRelationship.findUnique({ where: { id: 'b29f2e3a-6f0a-4b9a-bbcb-7c73a1d9ab01' } });
    ...
    const threatRel2 = await prisma_1.default.threatRelationship.findUnique({ where: { id: 'b29f2e3a-6f0a-4b9a-bbcb-7c73a1d9ab02' } });
    ...
    }), (id) => prisma_1.default.mitreTactic.findUnique({ where: { id } }), (id, val) => prisma_1.default.mitreTactic.update({ where: { id }, data: { tacticType: val } }), (id) => prisma_1.default.mitreTactic.delete({ where: { id } }));
    // CVESeverity
    await testEnum('CVESeverity', Object.values(client_1.CVESeverity), (val) => prisma_1.default.cVE.create({
        data: { cveId: `temp-${val}-${RUN}`, severity: val, cvssScore: 5.0, createdBy: 't', updatedBy: 't' }
    }), (id) => prisma_1.default.cVE.findUnique({ where: { id } }), (id, val) => prisma_1.default.cVE.update({ where: { id }, data: { severity: val } }), (id) => prisma_1.default.cVE.delete({ where: { id } }));
    // IOCType
    await testEnum('IOCType', Object.values(client_1.IOCType), (val) => prisma_1.default.iOC.create({
        data: { iocId: `temp-${val}-${RUN}`, value: 'v', iocType: val, severity: 'MEDIUM', confidence: 'HIGH', createdBy: 't', updatedBy: 't' }
    }), (id) => prisma_1.default.iOC.findUnique({ where: { id } }), (id, val) => prisma_1.default.iOC.update({ where: { id }, data: { iocType: val } }), (id) => prisma_1.default.iOC.delete({ where: { id } }));
    // IOCStatus
    await testEnum('IOCStatus', Object.values(client_1.IOCStatus), (val) => prisma_1.default.iOC.create({
        data: { iocId: `temp-st-${val}-${RUN}`, value: 'v', iocType: 'IP', severity: 'MEDIUM', status: val, confidence: 'HIGH', createdBy: 't', updatedBy: 't' }
    }), (id) => prisma_1.default.iOC.findUnique({ where: { id } }), (id, val) => prisma_1.default.iOC.update({ where: { id }, data: { status: val } }), (id) => prisma_1.default.iOC.delete({ where: { id } }));
    // ThreatLevel
    await testEnum('ThreatLevel', Object.values(client_1.ThreatLevel), (val) => prisma_1.default.threatActor.create({
        data: { threatId: `temp-tl-${val}-${RUN}`, name: 't', confidence: 'HIGH', severity: val, createdBy: 't', updatedBy: 't' }
    }), (id) => prisma_1.default.threatActor.findUnique({ where: { id } }), (id, val) => prisma_1.default.threatActor.update({ where: { id }, data: { severity: val } }), (id) => prisma_1.default.threatActor.delete({ where: { id } }));
    // ThreatStatus
    await testEnum('ThreatStatus', Object.values(client_1.ThreatStatus), (val) => prisma_1.default.threatActor.create({
        data: { threatId: `temp-${val}-${RUN}`, name: 't', confidence: 'HIGH', severity: 'MEDIUM', status: val, createdBy: 't', updatedBy: 't' }
    }), (id) => prisma_1.default.threatActor.findUnique({ where: { id } }), (id, val) => prisma_1.default.threatActor.update({ where: { id }, data: { status: val } }), (id) => prisma_1.default.threatActor.delete({ where: { id } }));
    // CampaignStatus
    await testEnum('CampaignStatus', Object.values(client_1.CampaignStatus), (val) => prisma_1.default.threatCampaign.create({
        data: { campaignId: `temp-${val}-${RUN}`, name: 't', confidence: 'HIGH', status: val, createdBy: 't', updatedBy: 't' }
    }), (id) => prisma_1.default.threatCampaign.findUnique({ where: { id } }), (id, val) => prisma_1.default.threatCampaign.update({ where: { id }, data: { status: val } }), (id) => prisma_1.default.threatCampaign.delete({ where: { id } }));
    // RelationshipType
    await testEnum('RelationshipType', Object.values(client_1.RelationshipType), (val) => prisma_1.default.threatRelationship.create({
        data: { targetType: 'cve', relationType: val, confidence: 90.0, createdBy: 't', updatedBy: 't' }
    }), (id) => prisma_1.default.threatRelationship.findUnique({ where: { id } }), (id, val) => prisma_1.default.threatRelationship.update({ where: { id }, data: { relationType: val } }), (id) => prisma_1.default.threatRelationship.delete({ where: { id } }));
    // ───────────────────────────────────────────────────────────────────────────
    ...
    // 1. MitreTactic
    await testCRUD('MitreTactic', () => prisma_1.default.mitreTactic.create({
        data: { tacticKey: `crud-${RUN}`, name: 't', tacticType: 'EXECUTION', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.mitreTactic.findUnique({ where: { id } }), (id) => prisma_1.default.mitreTactic.update({
        where: { id },
        data: { name: 't-mod', version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.mitreTactic.delete({ where: { id } }));
    // 2. MitreTechnique
    await testCRUD('MitreTechnique', () => prisma_1.default.mitreTechnique.create({
        data: { mitreId: `crud-${RUN}`, name: 't', severity: 'MEDIUM', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.mitreTechnique.findUnique({ where: { id } }), (id) => prisma_1.default.mitreTechnique.update({
        where: { id },
        data: { name: 't-mod', version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.mitreTechnique.delete({ where: { id } }));
    // 3. MitreMitigation
    await testCRUD('MitreMitigation', () => prisma_1.default.mitreMitigation.create({
        data: { mitreId: `crud-${RUN}`, name: 't', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.mitreMitigation.findUnique({ where: { id } }), (id) => prisma_1.default.mitreMitigation.update({
        where: { id },
        data: { name: 't-mod', version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.mitreMitigation.delete({ where: { id } }));
    // 4. CVE
    await testCRUD('CVE', () => prisma_1.default.cVE.create({
        data: { cveId: `crud-${RUN}`, severity: 'MEDIUM', cvssScore: 5.0, createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.cVE.findUnique({ where: { id } }), (id) => prisma_1.default.cVE.update({
        where: { id },
        data: { cvssScore: 6.0, version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.cVE.delete({ where: { id } }));
    // 5. CVSS
    const tempCVE = await prisma_1.default.cVE.create({
        data: { cveId: `crud-temp-${RUN}`, severity: 'MEDIUM', cvssScore: 5.0, createdBy: 't', updatedBy: 't' }
    });
    await testCRUD('CVSS', () => prisma_1.default.cVSS.create({
        data: { cveId: tempCVE.id, baseScore: 5.0, severity: 'MEDIUM', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.cVSS.findUnique({ where: { id } }), (id) => prisma_1.default.cVSS.update({
        where: { id },
        data: { baseScore: 6.0, version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.cVSS.delete({ where: { id } }));
    await prisma_1.default.cVE.delete({ where: { id: tempCVE.id } });
    // 6. AffectedProduct
    const tempCVE2 = await prisma_1.default.cVE.create({
        data: { cveId: `crud-temp2-${RUN}`, severity: 'MEDIUM', cvssScore: 5.0, createdBy: 't', updatedBy: 't' }
    });
    await testCRUD('AffectedProduct', () => prisma_1.default.affectedProduct.create({
        data: { cveId: tempCVE2.id, vendor: 'v', product: 'p', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.affectedProduct.findUnique({ where: { id } }), (id) => prisma_1.default.affectedProduct.update({
        where: { id },
        data: { product: 'p-mod', version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.affectedProduct.delete({ where: { id } }));
    await prisma_1.default.cVE.delete({ where: { id: tempCVE2.id } });
    // 7. IOC
    await testCRUD('IOC', () => prisma_1.default.iOC.create({
        data: { iocId: `crud-${RUN}`, value: 'v', iocType: 'IP', severity: 'MEDIUM', confidence: 'HIGH', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.iOC.findUnique({ where: { id } }), (id) => prisma_1.default.iOC.update({
        where: { id },
        data: { value: 'v-mod', version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.iOC.delete({ where: { id } }));
    // 8. IOCRelationship
    const tempIOC = await prisma_1.default.iOC.create({
        data: { iocId: `crud-temp-${RUN}`, value: 'v', iocType: 'IP', severity: 'MEDIUM', confidence: 'HIGH', createdBy: 't', updatedBy: 't' }
    });
    await testCRUD('IOCRelationship', () => prisma_1.default.iOCRelationship.create({
        data: { iocId: tempIOC.id, targetType: 'cve', relationType: 'EXPLOITS', confidence: 90.0, createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.iOCRelationship.findUnique({ where: { id } }), (id) => prisma_1.default.iOCRelationship.update({
        where: { id },
        data: { confidence: 95.0, version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.iOCRelationship.delete({ where: { id } }));
    await prisma_1.default.iOC.delete({ where: { id: tempIOC.id } });
    // 9. IOCEnrichment
    const tempIOC2 = await prisma_1.default.iOC.create({
        data: { iocId: `crud-temp2-${RUN}`, value: 'v', iocType: 'IP', severity: 'MEDIUM', confidence: 'HIGH', createdBy: 't', updatedBy: 't' }
    });
    await testCRUD('IOCEnrichment', () => prisma_1.default.iOCEnrichment.create({
        data: { iocId: tempIOC2.id, reputationScore: 50, malicious: true, provider: 'p', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.iOCEnrichment.findUnique({ where: { id } }), (id) => prisma_1.default.iOCEnrichment.update({
        where: { id },
        data: { reputationScore: 60, version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.iOCEnrichment.delete({ where: { id } }));
    await prisma_1.default.iOC.delete({ where: { id: tempIOC2.id } });
    // 10. ThreatActor
    await testCRUD('ThreatActor', () => prisma_1.default.threatActor.create({
        data: { threatId: `crud-${RUN}`, name: 't', confidence: 'HIGH', severity: 'MEDIUM', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.threatActor.findUnique({ where: { id } }), (id) => prisma_1.default.threatActor.update({
        where: { id },
        data: { name: 't-mod', version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.threatActor.delete({ where: { id } }));
    // 11. ThreatCampaign
    await testCRUD('ThreatCampaign', () => prisma_1.default.threatCampaign.create({
        data: { campaignId: `crud-${RUN}`, name: 't', confidence: 'HIGH', createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.threatCampaign.findUnique({ where: { id } }), (id) => prisma_1.default.threatCampaign.update({
        where: { id },
        data: { name: 't-mod', version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.threatCampaign.delete({ where: { id } }));
    // 12. ThreatRelationship
    await testCRUD('ThreatRelationship', () => prisma_1.default.threatRelationship.create({
        data: { targetType: 'cve', relationType: 'EXPLOITS', confidence: 90.0, createdBy: 'crud_test', updatedBy: 'crud_test' }
    }), (id) => prisma_1.default.threatRelationship.findUnique({ where: { id } }), (id) => prisma_1.default.threatRelationship.update({
        where: { id },
        data: { confidence: 95.0, version: 2, updatedBy: 'crud_test_updated' }
    }), (id) => prisma_1.default.threatRelationship.delete({ where: { id } }));
    // ───────────────────────────────────────────────────────────────────────────
    ...
    const softDeleteModels = [
        {
            name: 'MitreTactic',
            createFn: () => prisma_1.default.mitreTactic.create({ data: { tacticKey: `soft-${RUN}`, name: 't', tacticType: 'EXECUTION', createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.mitreTactic.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.mitreTactic.delete({ where: { id } }),
        },
        {
            name: 'MitreTechnique',
            createFn: () => prisma_1.default.mitreTechnique.create({ data: { mitreId: `soft-${RUN}`, name: 't', createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.mitreTechnique.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.mitreTechnique.delete({ where: { id } }),
        },
        {
            name: 'MitreMitigation',
            createFn: () => prisma_1.default.mitreMitigation.create({ data: { mitreId: `soft-${RUN}`, name: 't', createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.mitreMitigation.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.mitreMitigation.delete({ where: { id } }),
        },
        {
            name: 'CVE',
            createFn: () => prisma_1.default.cVE.create({ data: { cveId: `soft-${RUN}`, severity: 'MEDIUM', cvssScore: 5.0, createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.cVE.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.cVE.delete({ where: { id } }),
        },
        {
            name: 'CVSS',
            createFn: async () => {
                const c = await prisma_1.default.cVE.create({ data: { cveId: `soft-cvss-${RUN}`, severity: 'MEDIUM', cvssScore: 5.0, createdBy: 't', updatedBy: 't' } });
                return prisma_1.default.cVSS.create({ data: { cveId: c.id, baseScore: 5.0, severity: 'MEDIUM', createdBy: 't', updatedBy: 't' } });
            },
            updateFn: (id, d) => prisma_1.default.cVSS.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: async (id) => {
                const record = await prisma_1.default.cVSS.findUnique({ where: { id } });
                if (record) {
                    await prisma_1.default.cVSS.delete({ where: { id } });
                    await prisma_1.default.cVE.delete({ where: { id: record.cveId } });
                }
            },
        },
        {
            ...
            createFn: async () => {
                const c = await prisma_1.default.cVE.create({ data: { cveId: `soft-ap-${RUN}`, severity: 'MEDIUM', cvssScore: 5.0, createdBy: 't', updatedBy: 't' } });
                return prisma_1.default.affectedProduct.create({ data: { cveId: c.id, vendor: 'v', product: 'p', createdBy: 't', updatedBy: 't' } });
            },
            updateFn: (id, d) => prisma_1.default.affectedProduct.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: async (id) => {
                const record = await prisma_1.default.affectedProduct.findUnique({ where: { id } });
                if (record) {
                    await prisma_1.default.affectedProduct.delete({ where: { id } });
                    await prisma_1.default.cVE.delete({ where: { id: record.cveId } });
                }
            },
        },
        {
            name: 'IOC',
            createFn: () => prisma_1.default.iOC.create({ data: { iocId: `soft-${RUN}`, value: 'v', iocType: 'IP', severity: 'MEDIUM', confidence: 'HIGH', createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.iOC.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.iOC.delete({ where: { id } }),
        },
        {
            name: 'IOCRelationship',
            createFn: async () => {
                const ioc = await prisma_1.default.iOC.create({ data: { iocId: `soft-rel-${RUN}`, value: 'v', iocType: 'IP', severity: 'MEDIUM', confidence: 'HIGH', createdBy: 't', updatedBy: 't' } });
                return prisma_1.default.iOCRelationship.create({ data: { iocId: ioc.id, targetType: 'cve', relationType: 'EXPLOITS', confidence: 90, createdBy: 't', updatedBy: 't' } });
            },
            updateFn: (id, d) => prisma_1.default.iOCRelationship.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: async (id) => {
                const record = await prisma_1.default.iOCRelationship.findUnique({ where: { id } });
                if (record) {
                    await prisma_1.default.iOCRelationship.delete({ where: { id } });
                    await prisma_1.default.iOC.delete({ where: { id: record.iocId } });
                }
            },
        },
        {
            name: 'IOCEnrichment',
            createFn: async () => {
                const ioc = await prisma_1.default.iOC.create({ data: { iocId: `soft-enc-${RUN}`, value: 'v', iocType: 'IP', severity: 'MEDIUM', confidence: 'HIGH', createdBy: 't', updatedBy: 't' } });
                return prisma_1.default.iOCEnrichment.create({ data: { iocId: ioc.id, reputationScore: 50, malicious: true, provider: 'p', createdBy: 't', updatedBy: 't' } });
            },
            updateFn: (id, d) => prisma_1.default.iOCEnrichment.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: async (id) => {
                const record = await prisma_1.default.iOCEnrichment.findUnique({ where: { id } });
                if (record) {
                    await prisma_1.default.iOCEnrichment.delete({ where: { id } });
                    await prisma_1.default.iOC.delete({ where: { id: record.iocId } });
                }
            },
        },
        {
            name: 'ThreatActor',
            createFn: () => prisma_1.default.threatActor.create({ data: { threatId: `soft-${RUN}`, name: 't', confidence: 'HIGH', severity: 'MEDIUM', createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.threatActor.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.threatActor.delete({ where: { id } }),
        },
        {
            name: 'ThreatCampaign',
            createFn: () => prisma_1.default.threatCampaign.create({ data: { campaignId: `soft-${RUN}`, name: 't', confidence: 'HIGH', createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.threatCampaign.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.threatCampaign.delete({ where: { id } }),
        },
        {
            name: 'ThreatRelationship',
            createFn: () => prisma_1.default.threatRelationship.create({ data: { targetType: 'cve', relationType: 'EXPLOITS', confidence: 90, createdBy: 't', updatedBy: 't' } }),
            updateFn: (id, d) => prisma_1.default.threatRelationship.update({ where: { id }, data: { deletedAt: d } }),
            deleteFn: (id) => prisma_1.default.threatRelationship.delete({ where: { id } }),
        },
    ];
    ...
    const popTech1 = await prisma_1.default.mitreTechnique.findUnique({
        where: { id: tech1.id },
    ...
    const popIoc1 = await prisma_1.default.iOC.findUnique({
        where: { id: ioc1.id },
    ...
    const popCve1 = await prisma_1.default.cVE.findUnique({
        where: { id: cve1.id },
    ...
    const setNullTactic = await prisma_1.default.mitreTactic.create({
        data: { tacticKey: `setnull-${RUN}`, name: 't', tacticType: 'EXECUTION', createdBy: 't', updatedBy: 't' }
    });
    const setNullTechnique = await prisma_1.default.mitreTechnique.create({
        data: { mitreId: `setnull-${RUN}`, name: 't', tacticId: setNullTactic.id, createdBy: 't', updatedBy: 't' }
    });
    await prisma_1.default.mitreTactic.delete({ where: { id: setNullTactic.id } });
    const checkTech = await prisma_1.default.mitreTechnique.findUnique({ where: { id: setNullTechnique.id } });
    ...
    await prisma_1.default.mitreTechnique.delete({ where: { id: setNullTechnique.id } });
    // B. Cascade delete on CVE
    const casCVE = await prisma_1.default.cVE.create({
        data: { cveId: `cas-${RUN}`, severity: 'CRITICAL', cvssScore: 10.0, createdBy: 't', updatedBy: 't' }
    });
    const casCVSS = await prisma_1.default.cVSS.create({
        data: { cveId: casCVE.id, baseScore: 10.0, severity: 'CRITICAL', createdBy: 't', updatedBy: 't' }
    });
    const casProd = await prisma_1.default.affectedProduct.create({
        data: { cveId: casCVE.id, vendor: 'v', product: 'p', createdBy: 't', updatedBy: 't' }
    });
    const casIOC = await prisma_1.default.iOC.create({
        data: { iocId: `cas-${RUN}`, value: 'v', iocType: 'IP', severity: 'CRITICAL', confidence: 'HIGH', createdBy: 't', updatedBy: 't' }
    });
    const casIOCRel = await prisma_1.default.iOCRelationship.create({
        data: { iocId: casIOC.id, cveId: casCVE.id, targetType: 'cve', relationType: 'EXPLOITS', confidence: 100, createdBy: 't', updatedBy: 't' }
    });
    const casThreatRel = await prisma_1.default.threatRelationship.create({
        data: { cveId: casCVE.id, targetType: 'cve', relationType: 'EXPLOITS', confidence: 100, createdBy: 't', updatedBy: 't' }
    });
    await prisma_1.default.cVE.delete({ where: { id: casCVE.id } });
    assert(await prisma_1.default.cVSS.findUnique({ where: { id: casCVSS.id } }) === null, '[Cascade CVE] CVSS deleted');
    assert(await prisma_1.default.affectedProduct.findUnique({ where: { id: casProd.id } }) === null, '[Cascade CVE] AffectedProduct deleted');
    assert(await prisma_1.default.iOCRelationship.findUnique({ where: { id: casIOCRel.id } }) === null, '[Cascade CVE] IOCRelationship deleted');
    assert(await prisma_1.default.threatRelationship.findUnique({ where: { id: casThreatRel.id } }) === null, '[Cascade CVE] ThreatRelationship deleted');
    // Clean up
    await prisma_1.default.iOC.delete({ where: { id: casIOC.id } });
    // C. Cascade delete on IOC
    const casIOC2 = await prisma_1.default.iOC.create({
        data: { iocId: `cas2-${RUN}`, value: 'v', iocType: 'IP', severity: 'CRITICAL', confidence: 'HIGH', createdBy: 't', updatedBy: 't' }
    });
    const casEnr = await prisma_1.default.iOCEnrichment.create({
        data: { iocId: casIOC2.id, reputationScore: 100, malicious: true, provider: 'p', createdBy: 't', updatedBy: 't' }
    });
    const casIOCRel2 = await prisma_1.default.iOCRelationship.create({
        data: { iocId: casIOC2.id, targetType: 'cve', relationType: 'EXPLOITS', confidence: 100, createdBy: 't', updatedBy: 't' }
    });
    const casThreatRel2 = await prisma_1.default.threatRelationship.create({
        data: { iocId: casIOC2.id, targetType: 'ioc', relationType: 'EXPLOITS', confidence: 100, createdBy: 't', updatedBy: 't' }
    });
    await prisma_1.default.iOC.delete({ where: { id: casIOC2.id } });
    assert(await prisma_1.default.iOCEnrichment.findUnique({ where: { id: casEnr.id } }) === null, '[Cascade IOC] Enrichment deleted');
    assert(await prisma_1.default.iOCRelationship.findUnique({ where: { id: casIOCRel2.id } }) === null, '[Cascade IOC] IOCRelationship deleted');
    assert(await prisma_1.default.threatRelationship.findUnique({ where: { id: casThreatRel2.id } }) === null, '[Cascade IOC] ThreatRelationship deleted');
    ...
    await assertUniqueConflict(() => prisma_1.default.mitreTactic.create({ data: { tacticKey: 'TA0002', name: 't', tacticType: 'EXECUTION', createdBy: 't', updatedBy: 't' } }), 'Duplicate tacticKey');
    await assertUniqueConflict(() => prisma_1.default.mitreTechnique.create({ data: { mitreId: 'T1059', name: 't', createdBy: 't', updatedBy: 't' } }), 'Duplicate mitreId in MitreTechnique');
    await assertUniqueConflict(() => prisma_1.default.mitreMitigation.create({ data: { mitreId: 'M1038', name: 't', createdBy: 't', updatedBy: 't' } }), 'Duplicate mitreId in MitreMitigation');
    await assertUniqueConflict(() => prisma_1.default.cVE.create({ data: { cveId: 'CVE-2021-44228', severity: 'CRITICAL', cvssScore: 10, createdBy: 't', updatedBy: 't' } }), 'Duplicate cveId in CVE');
    await assertUniqueConflict(() => prisma_1.default.cVSS.create({ data: { cveId: cve1.id, baseScore: 10, severity: 'CRITICAL', createdBy: 't', updatedBy: 't' } }), 'Duplicate cveId in CVSS');
    await assertUniqueConflict(() => prisma_1.default.iOC.create({ data: { iocId: 'ioc-ip-log4j', value: 'v', iocType: 'IP', severity: 'CRITICAL', confidence: 'HIGH', createdBy: 't', updatedBy: 't' } }), 'Duplicate iocId in IOC');
    await assertUniqueConflict(() => prisma_1.default.iOCEnrichment.create({ data: { iocId: ioc1.id, reputationScore: 10, malicious: true, provider: 'p', createdBy: 't', updatedBy: 't' } }), 'Duplicate iocId in IOCEnrichment');
    await assertUniqueConflict(() => prisma_1.default.threatActor.create({ data: { threatId: 'G0100', name: 't', confidence: 'HIGH', severity: 'CRITICAL', createdBy: 't', updatedBy: 't' } }), 'Duplicate threatId in ThreatActor');
    await assertUniqueConflict(() => prisma_1.default.threatCampaign.create({ data: { campaignId: 'C0055', name: 't', confidence: 'HIGH', createdBy: 't', updatedBy: 't' } }), 'Duplicate campaignId in ThreatCampaign');
    ...
    try {
        const listTech = await prisma_1.default.mitreTechnique.findMany({ where: { mitreId: 'T1059' } });
        assert(listTech.length >= 1, 'Index lookup by mitreId successful');
        const listCVE = await prisma_1.default.cVE.findMany({ where: { cveId: 'CVE-2021-44228' } });
        assert(listCVE.length >= 1, 'Index lookup by cveId successful');
        const listIOC = await prisma_1.default.iOC.findMany({ where: { iocId: 'ioc-ip-log4j' } });
        assert(listIOC.length >= 1, 'Index lookup by iocId successful');
        const listActor = await prisma_1.default.threatActor.findMany({ where: { threatId: 'G0100' } });
        assert(listActor.length >= 1, 'Index lookup by threatId successful');
        const listCampaign = await prisma_1.default.threatCampaign.findMany({ where: { campaignId: 'C0055' } });
        assert(listCampaign.length >= 1, 'Index lookup by campaignId successful');
        const listSeverity = await prisma_1.default.cVE.findMany({ where: { severity: 'CRITICAL' } });
        assert(listSeverity.length >= 1, 'Index lookup by severity successful');
        const listStatus = await prisma_1.default.iOC.findMany({ where: { status: 'ACTIVE' } });
        assert(listStatus.length >= 1, 'Index lookup by status successful');
        const listCreatedAt = await prisma_1.default.cVE.findMany({ where: { createdAt: { lte: new Date() } } });
        assert(listCreatedAt.length >= 1, 'Index lookup by createdAt successful');
        const listUpdatedAt = await prisma_1.default.cVE.findMany({ where: { updatedAt: { lte: new Date() } } });
